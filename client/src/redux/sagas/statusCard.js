...
import {
  addDeleteStatusSuccess,
  addLoseStatusSuccess,
  addMoveStatusSuccess,
  addWinStatusSuccess,
} from "../actions/statusCard";
...
export function* watchActionStatusCard() {
  ...
  yield takeEvery(
    typeStatus.ADD_LOSE_STATUS_REQUEST,
    getAddLoseStatusCardSagas
  );
  yield takeEvery(
    typeStatus.ADD_DELETE_STATUS_REQUEST,
    getAddDeleteStatusCardSagas
  );
  yield takeEvery(
    typeStatus.ADD_MOVETO_STATUS_REQUEST,
    getAddMoveStatusCardSagas
  );
}
